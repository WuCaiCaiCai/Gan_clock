...
**当前阶段:** 番茄钟主流程已完成，主界面改为沉浸式数字计时、浮动 dock、阶段配色提示，并加入后台画中画、屏幕常亮和热力图选日。
...
### 动效
- [x] 番茄钟启动动效 — 数字轻微脉冲、背景进度缓出补间、阶段文字淡切
- [x] 闲置静默显示 — 运行中无操作或点击空白区域后淡出导航和操作区，仅保留同位置番茄钟
- [x] 阶段配色动画 — 专注红褐、短休绿色、长休蓝色同步作用于背景、数字和进度
...
- [x] 计时引擎 — 纯 Dart，跨平台复用
- [x] 主计时页面 — 大数字倒计时、背景进度、开始/暂停/跳过按钮
